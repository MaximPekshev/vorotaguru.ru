...
from .views import show_index_page, show_private_client_page, show_corporate_client_page, show_privacy_policy
...
urlpatterns = [
	...
	path('privacy-policy/', 	show_privacy_policy, name='show_privacy_policy'),
